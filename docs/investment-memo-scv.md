...
**Date**: March 2026 | **Stage**: Pre-Seed / Joint Venture | **Partner**: SC Ventures | **Market**: Pan-Asia (Singapore first)
...
## Solution: 7-Layer Agentic Banking Stack
...
| SC Ventures Brings | We Bring |
|--------------------|----------|
| MAS regulatory pathway + sandbox sponsorship | Full-stack product engineering (7-layer infra) |
| Pan-Asia banking licenses (SG, HK, UAE) | AI-native UX + developer API |
| Enterprise distribution (SC corporate clients) | Operational execution (build → ship → iterate) |
| Venture governance (Zodia/Nexus/Libeara playbook) | Domain expertise: fintech infra + agent systems |

**Operating Model**: Separate legal entity (Zodia archetype). SCV = origination/regulatory/distribution. We = product/eng/ops. Stage-gate governance with clear DRI ownership.

## Go-to-Market

**Phase 1 (Month 0-8)**: Singapore — MAS FinTech Regulatory Sandbox. Single rail (SGD domestic). 3 pilot customers from SC network.
...
**Joint venture formation** with SC Ventures to build AOA as a standalone entity.

- **Capital**: $3-5M seed (SCV lead or co-invest)
- **Regulatory**: MAS sandbox sponsorship via SC banking license
- **Distribution**: 3 pilot enterprise introductions from SC corporate network
